...
function initialize() {
	...
	//=======================================================================================
		...
		mapTypeId: google.maps.MapTypeId.ROADMAP,
			center: new google.maps.LatLng(45.569335, 5.921717),
		panControl: true,
			zoomControl: true,
			mapTypeControl: true,
			//scaleControl: false,
	...
	var marker1 = new MarkerWithLabel({
				position: new google.maps.LatLng(45.5724579,5.9239268),
				draggable: false,
				raiseOnDrag: false,
				icon: ' ',
				map: map,
				labelContent: '<a href="https://goo.gl/maps/CePs44Vmsjx"><div class="de-icon circle medium-size" style="background-color:#FFF; border:1px solid #f0394d"><i class="de-icon-heart-8" style="color:#f0394d"></i></div></a>',
	...
	//INFO WINDOWS
	//=======================================================================================
	var contentString = '<a href="https://goo.gl/maps/3339apDAMZS2"><div>'+
