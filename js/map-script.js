...
function initialize() {
	...
	var marker1 = new MarkerWithLabel({
				...
				icon: ' ',
				map: map,
				labelContent: '<div class="de-icon circle medium-size" style="background-color:#FFF; border:1px solid #f0394d"><i class="de-icon-heart-empty" style="color:#f0394d"></i></div>',
